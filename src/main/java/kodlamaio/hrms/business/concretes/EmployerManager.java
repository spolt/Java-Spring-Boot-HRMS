...
public class EmployerManager implements EmployerService{
	...
	public Result addEmployer(Employer employer) {
				...
				return new SuccessResult("Success: İş veren kullanıcı sisteme eklendi. Doğrulama kodu gönderildi.");
				
	}

	@Override
	public DataResult<Employer> getUserByEmail(String email) {
		return new SuccessDataResult<Employer>(this.employerDao.findUserByEmail(email));
	}
